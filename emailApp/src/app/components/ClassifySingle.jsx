...
export default function ClassifySingle({ onClassify }) {
  ...
  const getConfidenceColor = (confidence) => {
    if (confidence >= 0.90) return '#0F6E56';
    if (confidence >= 0.80) return '#185FA5';
    if (confidence >= 0.70) return '#854F0B';
    return '#A32D2D';
  };
          ...
          <AnimatePresence mode="wait">
            {activeResult ? (
              ...
              >
                ...
                >
                  <CheckCircle2 size={18} style={{ color: activeResult.config.color }} />
                  <span className="text-sm font-bold" style={{ color: activeResult.config.color }}>
                    Classified as {activeResult.category}
                  </span>
                  {result && (
                    <span className="ml-auto text-xs px-2 py-0.5 rounded-full bg-white/60 font-medium"
                ...
                <div className="p-4 bg-white dark:bg-gray-800 space-y-3">
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <span className="text-lg font-bold"
                        style={{ color: getConfidenceColor(activeResult.confidence) }}>
                    ...
                    <div className="w-full bg-gray-100 dark:bg-gray-700 rounded-full h-2.5 overflow-hidden">
                      <motion.div
                        ...
                        style={{ backgroundColor: getConfidenceColor(activeResult.confidence) }}
                      />
                    </div>
                  </div>
                  <div className="pt-2 border-t border-gray-100 dark:border-gray-700 space-y-1.5">
                    ...
                    <div className="flex gap-2 text-xs">
                      <span className="text-gray-400 w-14 flex-shrink-0">Method</span>
              ...
              >
                ...
                <div>
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">No result yet</p>
